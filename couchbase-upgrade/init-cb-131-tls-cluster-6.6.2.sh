...
-subj "/CN=Couchbase Cluster CA/OU=Engineering/O=Acme/L=Bangalore/ST=Karnataka/C=IN"
...
-subj "/CN=Couchbase Node 131/OU=Engineering/O=Acme/L=Bangalore/ST=Karnataka/C=IN"
